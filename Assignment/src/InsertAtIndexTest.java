...
public class InsertAtIndexTest extends SetupTests {

	@Test
	public void test() {
		
		//Negative index test for empty linked list
		empty.insertAtIndex(-1, 40);
		...
		multi.insertAtIndex(2, 40);
		ArrayList<Integer> answer8 = new ArrayList<Integer>( Arrays.asList(4,3,40,5,7,1,6));
		assertEquals(multi.getLinkedList(), answer8);
		
		//Index out of bounds test for multiple element linked list
		multi.insertAtIndex(40, 40);
		ArrayList<Integer> answer9 = new ArrayList<Integer>( Arrays.asList(4,3,40,5,7,1,6));
